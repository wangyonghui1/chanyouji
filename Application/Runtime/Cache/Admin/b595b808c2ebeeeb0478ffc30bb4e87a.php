    ...
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        ...
        <div class="login-msg ue-clear"> 
          <a href="<?php echo U('Email/recBox');?>" target="main" class="msg-txt">
                消息
          </a>
           <a href="<?php echo U('Email/recBox');?>" target="main" class="msg-num">
                10
           </a> 
         </div>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="email">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>邮件管理</span><i class="icon"></i></a></div>
             <ul class="subnav">
              <li><a href="javascript:;" date-src="<?php echo U('Email/send');?>">写信</a></li>
